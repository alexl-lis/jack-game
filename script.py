...
tips = [
    Tip(6, 6, "Двоичная система счисления №1", "Основанием двоичной системы счисления является 2."),
    Tip(10, 10, "Алгебра логики №1", "Конъюнция - это логическая операция, ставящая в соответствие каждым двум простым высказываниям составное высказывание, являющееся истинным тогда и только тогда, когда оба исходных высказывания истинны."),
    Tip(4, 6, "Информация №1", "Информацию, существенную и важную в настоящий момент, называют актуальной."),
    Tip(15,11 , "Excel №1", "Основное назначение электронных таблиц- выполнять расчет по формулам"),
    Tip(7, 6, "Двоичная система счисления №2", "В двоичном коде после числа 111 идет число 1000"),
    Tip(2, 10, "Алгебра логики №2", "Дизъюнкция - это логическая операция, ставящая в соответствие каждым двум простым высказываниям составное высказывание, являющееся истинным тогда и только тогда, когда оба исходных высказывания ложны."),
    Tip(1, 9, "Информация №2", "Обработка информации - вся совокупность операций (сбор, ввод, запись, преобразование, считывание, хранение, уничтожение, регистрация)"),
    Tip(11,4 , "Excel №2", "Word не является электронной таблицей"),
]
